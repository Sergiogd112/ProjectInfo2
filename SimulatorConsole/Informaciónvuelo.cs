...
namespace Flight_Forms
{
    public partial class Informaciónvuelo : Form
    {
        ...
        private void Informaciónvuelo_Load(object sender, EventArgs e)
        {
            ...
            inPosBox.Text=Convert.ToString("X: "+ Math.Round(this.vuelo.GetInitialPosition().GetX(), 2) + "Y: "+ Math.Round(this.vuelo.GetInitialPosition().GetY(), 2));
            currPosBox.Text= Convert.ToString("X: " + Math.Round(this.vuelo.GetCurrentPosition().GetX(), 2) + "Y: " + Math.Round(this.vuelo.GetCurrentPosition().GetY(), 2));
            finPosBox.Text= Convert.ToString("X: " + Math.Round(this.vuelo.GetFinalPosition().GetX(), 2) + "Y: " + Math.Round(this.vuelo.GetFinalPosition().GetY(), 2));
        }
